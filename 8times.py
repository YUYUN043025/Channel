...
images_path = '/userhome/cs2/yyxyy/nerf/GP_data/nerf_llff_data/Channel1/images/' # 原图路径
output_dir = '/userhome/cs2/yyxyy/nerf/GP_data/nerf_llff_data/Channel1/images_8/' # resize后路径
